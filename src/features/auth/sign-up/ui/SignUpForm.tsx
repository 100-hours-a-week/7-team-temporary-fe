  ...
  return (
    ...
    >
      ...
      >
        <>
          <div className="flex w-full gap-2">
            <NicknameInput register={register("nickname")} />
            <button
      ...
      <FormField
        ...
        error={birthError}
      >
        <BirthDateInput register={register("birth")} />
      </FormField>
      <FormField
        label="집중 시간대"
        error={focusTimeZoneError}
      >
        <FocusTimeZoneSelect register={register("focusTimeZone")} />
      </FormField>
      <FormField
        label="하루 종료 시간"
        error={dayEndTimeError}
      >
        <DayEndTimeInput register={register("dayEndTime")} />
      </FormField>
      <FormField
        label="프로필 이미지 키 (선택)"
        error={profileImageKeyError}
      >
        <ProfileImageKeyInput register={register("profileImageKey")} />
      </FormField>
      <button
